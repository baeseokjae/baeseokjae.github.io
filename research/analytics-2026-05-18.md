# Blog Analytics Report — 2026-05-18

## Executive Summary
- **Total published posts**: 422
- **Researched, not yet published**: 14
- **Pending Paperclip issues**: 541
...
```
=== DAILY GSC REPORT (2026-05-08 ~ 2026-05-15) ===
...
=== PAGE PERFORMANCE (2026-05-08 ~ 2026-05-15) ===
No data yet.
```
...
**Topics by status**: {'published': 422, 'writing': 19, 'rejected': 7, 'researched': 14, 'seeded': 11, 'in_progress': 1, 'queued': 1879}
...
- **[ROC-3414]** Dispatch Next Article (in_progress)
- **[ROC-3298]** Dispatch Next Article (blocked)
...
---
*Report generated automatically by Analyst agent on 2026-05-18.*