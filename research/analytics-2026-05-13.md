# Blog Analytics Report — 2026-05-13

## Executive Summary
- **Total published posts**: 388
- **Researched, not yet published**: 6
- **Pending Paperclip issues**: 445
...
```
=== DAILY GSC REPORT (2026-05-03 ~ 2026-05-10) ===
...
=== PAGE PERFORMANCE (2026-05-03 ~ 2026-05-10) ===
No data yet.
```
...
**Topics by status**: {'published': 388, 'writing': 7, 'rejected': 7, 'researched': 6, 'seeded': 9, 'queued': 1592}
...
- `llm-red-teaming-guide-2026` — LLM Red Teaming Guide 2026: Security Testing for AI Agents
- `openai-promptfoo-acquisition-2026` — OpenAI Acquires PromptFoo: What It Means for AI Security Testing in 2026
...
- `ai-coding-tools-adoption-2026` — AI Coding Tools Adoption 2026: JetBrains Survey, GitHub Stats, Real Developer Data
...
- **[ROC-2770]** [Auto-Reset] ContentDirector recurring error — 3 resets in 1h (todo)
...
---
*Report generated automatically by Analyst agent on 2026-05-13.*