...
|---|---|---|---|
| User satisfaction (2026) | 4.8/5 | ~4.5/5 | 4.1/5 |
| NPS | 54 | ~35 | ~20 |
| At-work adoption | 18% | 18% | 29% |
| Best use case | Multi-file agentic tasks | Daily editing, IDE integration | Inline autocomplete, GitHub workflow |
| Context window | 200K tokens | ~50K tokens | ~32K tokens |
| Interface | Terminal-first | IDE-native | IDE plugin |
| Startup market share | 75% primary tool | — | — |
| Enterprise (10K+) | Growing | — | 56% primary tool |
